...
#define VOIPCALL_SPK_KT			(0x01 << 9)
#define VOIPCALL_HP_KT			(0x01 << 10)
#define VOIPCALL_MAINMIC_KT		(0x01 << 11)
#define VOIPCALL_HPMIC_KT		(0x01 << 12)
...
enum voip_state		{VOIP_OFF, VOIP_ON, VOIP_ON_OTHER, KT_ON};
...
enum state_dock {DOCK_OFF, DOCK_ON};
#endif
